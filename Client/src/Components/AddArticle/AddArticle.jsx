...
const AddArticle = () => {
    ...
    return (
        <>
            {isAuthenticated ? (<div className="mx-auto w-[80%] m-[50px] pb-3 rounded-lg shadow-lg">
                <h1 className="text-4xl font-bold text-center font-sans py-5">Add Article</h1>
                    ...
                    <div className="flex items-center justify-center gap-10 px-[100px] pb-20">
                        ...
                        <div className="w-[50%] flex flex-col gap-10 pb-5">
                            <div className="w-full h-12">
                                <label htmlFor="title" className="text-xl font-sans px-1">Title</label>
                                <div className="flex">
                                    <input
                                        type="text"
                                        name="title"
                            ...
                            <div className="w-full h-12">
                                <label htmlFor="aboutarticle" className="text-xl font-sans px-1">About Article</label>
                                <div className="flex">
                                    <textarea
                                        type="text"
                                        name="aboutarticle"
                            ...
                            <div className="w-full mt-5 h-12">
                                <label htmlFor="Categories" className="text-xl font-sans px-1">Categories</label>
                                <div className="flex">
                                    <input
                                        type="text"
                                        name="Categories"
                            ...
                            <ul className="flex justify-start gap-10 flex-wrap">
                                {temp.map((item, index) => (
                                    <li key={index} className="px-3 py-1 rounded-[4px] hover:bg-gray-800 bg-[#031000] text-[#FFB340]">{item}</li>
                                ))}
                            </ul>
                        </div>
                    </div>
