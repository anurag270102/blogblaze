      ...
      <main className="container mx-auto mt-8">
        <div className="flex flex-wrap justify-center">
          <div className="w-full md:w-8/12 px-4 mb-8">
            ...
            />
            <h2 className="text-4xl font-bold mt-4 mb-2 text-justify">
              {data.title}
            </h2>
          ...
          <div className="antialiased max-w-screen-sm flex-1">
            <h3 className="text-2xl font-bold mt-4 mb-2 text-justify">
              Comments
            </h3>
            <div className="space-y-4 bg-[#031000] rounded-md mr-5 text-gray-400">
              ...
              {isAuthenticated && (
                <div className="w-full h-12">
                  <label htmlFor="" className="text-xl font-sans px-1">
                    Comment
                  </label>
                  <div className="flex">
                    <input
                    ...
                    />
                    <button
                      className="bg-[#031000] border border-t-0 rounded px-4 py-2 text-[#FFB340]"
