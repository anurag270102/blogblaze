...
const Featurepost = () => {
  return (
    <>
      <div className="">
        <h1 className="text-5xl font-bold items-center flex justify-center bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-sm ">
          Featured Posts
        </h1>
        <Carousel
              ...
              <div className="rounded overflow-hidden shadow-lg flex flex-col">
                <Link to={"/blog?search=health"}>
                  <div className="relative">
                    ...
                    <a href="#!">
                      <div className="text-xs absolute top-0 right-0 font-bold bg-white  px-4 py-2 text-black mt-3 mr-3 hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
                        Health
                      </div>
                    </a>
                  </div>
                  <div className="px-6 py-4 mb-auto">
                    ...
                    >
                      Simplest Health tips
                    </a>
                    <p className="text-gray-500 text-sm">
                      Stay hydrated, prioritize sleep, eat balanced meals, and
                ...
                <Link to={"/blog?search=tips"}>
                  ...
                  <div className="px-6 py-4 mb-auto">
                    <a
                      ...
                      className="font-medium text-lg  hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2"
                    >
                      Simplest Tips for everything
                    </a>
                    <p className="text-gray-500 text-sm">
                      Juggle tasks, cherish moments, nurture connections,
                      prioritize health, seek fulfillment, embrace challenges,
                      find joy.
                    </p>
                  </div>
                  <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                ...
                <Link to={"/blog?search=food"}>
                  ...
                  <div className="px-6 py-4 mb-auto">
                    <a
                      ...
                      className="font-medium text-lg  hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2"
                    >
                      Simplest Now Cooking is Easy
                    </a>
                    <p className="text-gray-500 text-sm">
                      How to Make Cooking Effortless: Simple Tips for a Seamless
                      Culinary Experience
                    </p>
                  </div>
                  <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
                ...
                <Link to={"/blog?search=social media"}>
                  ...
                  <div className="px-6 py-4 mb-auto">
                    <a
                      ...
                      className="font-medium text-lg  hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2"
                    >
                      Simplest World in Your Hand
                    </a>
                    <p className="text-gray-500 text-sm">
                      Mastering Social Media: Navigating the World at Your
                      Fingertips
                    </p>
                  </div>
                  <div className="px-6 py-3 flex flex-row items-center justify-between bg-gray-100">
