    ...
    <>
      ...
      <section className="w-full overflow-hidden dark:bg-gray-900">
        <div className="w-full mx-auto">
          ...
          <div className="xl:w-[80%] lg:w-[90%] md:w-[94%] sm:w-[96%] xs:w-[92%] mx-auto flex flex-col gap-4 justify-center items-center relative xl:-top-[6rem] lg:-top-[6rem] md:-top-[4rem] sm:-top-[3rem] xs:-top-[2.2rem]">
            ...
            <div className="px-2 flex rounded-sm bg-gray-200 text-gray-500 dark:bg-gray-700 dark:bg-opacity-30 dark:text-gray-700 hover:text-gray-600 hover:dark:text-gray-400">
              <Link
                to={isAuthenticated ? data[0].instagramurl : "/"}
                target="_blank"
              >
              ...
              <Link
                to={isAuthenticated ? data[0].twitterurl : "/"}
                target="_blank"
              >
                <div className="p-2 hover:text-primary hover:dark:text-primary">
                  <svg
              ...
              <Link
                to={isAuthenticated ? data[0].facebookurl : "/"}
                target="_blank"
              >
              ...
              <Link
                to={isAuthenticated ? data[0].youtubeurl : "/"}
                target="_blank"
              >
                <div className="p-2 hover:text-primary hover:dark:text-primary">
                  <svg
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M21.7 8.037a4.26 4.26 0 0 0-.789-1.964 2.84 2.84 0 0 0-1.984-.839c-2.767-.2-6.926-.2-6.926-.2s-4.157 0-6.928.2a2.836 2.836 0 0 0-1.983.839 4.225 4.225 0 0 0-.79 1.965 30.146 30.146 0 0 0-.2 3.206v1.5a30.12 30.12 0 0 0 .2 3.206c.094.712.364 1.39.784 1.972.604.536 1.38.837 2.187.848 1.583.151 6.731.2 6.731.2s4.158 0 6.927-.2a2.84 2.84 0 0 0 1.983-.848 4.24 4.24 0 0 0 .79-1.972c.133-1.058.198-2.124.2-3.19V11.24a29.49 29.49 0 0 0-.213-3.204ZM9.943 14.993V9.007l4.857 2.993-4.857 2.993Z"
                      clipRule="evenodd"
                    />
                  </svg>
                </div>
        ...
        <div className="flex w-full justify-between px-52">
          <h1 className="text-3xl py-2 font-bold  items-center flex justify-start bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-sm ">
            Post
          </h1>
          <button
            className="block  bg-[#FFB340] hover:bg-[#FFB340e5]  text-black rounded-lg px-6 py-3 font-semibold"
        ...
        <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
          <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {deletemessage ? (
              <div className="text-red-600 text-xl">{deletemessage}</div>
            ) : null}
            {userpost.map((post) => {
              return (
        ...
        <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
          {loading ? (
            ...
            <>
              {userarticel.length >= 1
                ? userarticel.slice(0, visibleCount).map((article) => (
                    <div
                      key={article._doc.id}
        ...
        <h1 className="text-3xl py-2 pl-52 font-bold  items-center flex justify-start bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-sm ">
          My Comments
        </h1>
