...
const PopularBlogger = () => {
  ...
  return (
    <>
      <div className="px-48">
        <h1 className="text-5xl font-bold items-center flex justify-center bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-sm my-5 py-2">
          Articles
        </h1>
        <div>
