...
const Login = () => {
  ...
  return (
    <>
      {/* <!-- component --> */}
      <div className="min-w-screen min-h-screen bg-[#031000] flex items-center justify-center px-5 py-5">
        <div
          className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
          style={{ maxWidth: "1000px" }}
        >
          <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-[#FFB340] py-10 px-10">
              <svg
              ...
              <div className="flex flex-col items-center justify-center">
                <div className="flex w-full mx-auto ">
                  <div className="w-full px-3 mb-5">
                    <label htmlFor="" className="text-xs font-semibold ml-5">
                      Email
                    </label>
                    <div className="flex">
                      <input
                        type="email"
                        name="email"
                        className="w-full ml-5 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-[#FFB340]"
                ...
                <div className="flex  items-center justify-center">
                  <div className="w-full  mb-5">
                    <button
                      className="block w-full max-w-xs mx-auto bg-[#FFB340] hover:bg-[#FFB340e5]  text-black rounded-lg px-6 py-3 font-semibold"
