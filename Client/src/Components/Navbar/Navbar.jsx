...
const Navbar = () => {
    ...
    return (
        <>
            <div className={active || pathname !== "/" ? "z-999 px-10 bg-[#FFB340] text-black font-normal flex flex-wrap justify-between  sticky top-0 transition-all duration-150 ease-in-out" : 'z-999 px-10 bg-[#031000] text-white flex flex-wrap justify-between  sticky top-0'}>
                {/* left */}
                <div className="flex gap-16">
                    {/* logo */}
                    <div>
                        <Link to={'/'} className=" cursor-pointer transition-all duration-150 ease-in-out"><img src={active || pathname !== "/" ? "/src/assets/Colorful Modern Concept Free B Logo_new.svg" : '/src/assets/Colorful Modern Concept Free B Logo.svg'} width={'100px'}></img></Link>
                    </div>

                    {/* content */}
                    <div className=" list-none flex items-center gap-10">
                        <Link to={'post'} className="text-[22px] font-normal font-sans">Post</Link>
                        <Link to={'about'} className="text-[22px] font-normal font-sans">About</Link>
                        <Link to={'contact'} className="text-[22px] font-normal font-sans">Contact</Link>
                        <Link to={'videos'} className="text-[22px] font-normal font-sans">Videos</Link>
                    </div>
                </div>
                {/* searchbar */}
