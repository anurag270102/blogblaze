          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 lg:w-2/3 flex flex-col gap-2">
              <h1 className=" text-4xl md:text-4xl lg:text-4xl text-white font-bold mb-6 leading-relaxed">
                Fuel Your Mind with
                <br></br>
                <h1 className="text-6xl font-extrabold -z-11 bg-gradient-to-r from-indigo-400 to-cyan-400 bg-clip-text text-transparent leading-70 py-2">
                  BlogBlaze
                </h1>
                ...
                <div className="flex items-center">
                  <div className="max-w-[10/12]">
                    <div className="relative flex items-center w-full h-12 rounded-lg focus-within:shadow-lg  overflow-hidden">
                      ...
                      />
                      <div className="grid place-items-center h-full w-12 text-gray-300 bg-white cursor-pointer" onClick={getSearchItem}>
                        <svg
